...
class MyForm extends React.Component {
    ...
    constructor(props) {
        ...
        this.onEmailChangesEventHandler = this.onEmailChangesEventHandler.bind(this);
    ...
    onEmailChangesEventHandler(event) {
        this.setState(() => {
            return {
    ...
    render() {
        return (
            ...
            <form onSubmit={this.onSubmitEventHandler}>
                ...
                <input id="email" type="text" value={this.state.email} onChange={this.onEmailChangesEventHandler}/>
                <br />
